...
public final class Attributed<T> {
     ...
     * @param attributeName
     *            : Nom de l'attribut.
     * @return Vrai si et seulement si les attributs incluent celui
     ...
     * @param attributeName
     *            : Nom de l'attribut.
     * @return La valeur associée à l'attribut donné, ou null si
     ...
     * @param defaultValue
     *            : Valur par défaut.
     * @return La valeur associée à l'attribut donné, ou la valeur par
     *         défaut donnée si celui-ci n'existe pas.
     */
     ...
     * @return La valeur entière associée à l'attribut donné, ou la
     *         valeur par défaut si celui-ci n'existe pas ou si la valeur qui
     *         lui est associée n'est pas un entier valide.
     */
